        ...
        <div style={{ display: 'flex', minHeight: '100vh', background: 'linear-gradient(135deg, #f8fafc 0%, #e2e8f0 100%)', color: '#0f172a', fontFamily: 'Inter, system-ui, sans-serif' }}>
            <aside style={{ width: '260px', margin: '1rem', padding: '1.5rem', display: 'flex', flexDirection: 'column', borderRadius: '1rem', background: '#ffffff', border: '1px solid #f1f5f9', boxShadow: '0 10px 15px -3px rgba(0,0,0,0.05)' }}>
                ...
                <nav style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', flex: 1 }}>
                    <a href="#" onClick={(e) => { e.preventDefault(); setActiveView('management'); }} style={{ padding: '0.875rem 1rem', display: 'flex', alignItems: 'center', gap: '0.75rem', background: activeView === 'management' ? '#eff6ff' : 'transparent', borderRadius: '0.75rem', color: activeView === 'management' ? '#2563eb' : '#64748b', fontWeight: activeView === 'management' ? '600' : '500', textDecoration: 'none', transition: 'all 0.2s' }}>
                        <CheckSquare size={20} /> Complaint Management
                    </a>
                    <a href="#" onClick={(e) => { e.preventDefault(); setActiveView('all'); }} style={{ padding: '0.875rem 1rem', display: 'flex', alignItems: 'center', gap: '0.75rem', background: activeView === 'all' ? '#eff6ff' : 'transparent', borderRadius: '0.75rem', color: activeView === 'all' ? '#2563eb' : '#64748b', fontWeight: activeView === 'all' ? '600' : '500', textDecoration: 'none', transition: 'all 0.2s' }}>
            ...
            <main style={{ flex: 1, padding: '2rem 3rem 2rem 1rem', display: 'flex', flexDirection: 'column', gap: '2rem', overflowY: 'auto' }}>

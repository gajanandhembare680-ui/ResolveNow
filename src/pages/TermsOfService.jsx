    ...
    return (
        <div style={{
            ...
            <main style={{
                ...
                <h1 style={{ fontSize: '2.5rem', fontWeight: '800', color: '#0f172a', marginBottom: '1rem', letterSpacing: '-0.025em' }}>Terms of Service</h1>
                ...
                <section style={{ marginBottom: '2.5rem' }}>
                    ...
                    <p style={{ lineHeight: '1.7', marginBottom: '1rem' }}>
                        By accessing or using ResolveIt, you agree to be bound by these Terms of Service. If you disagree with any part of the terms, then you may not access the service.
                    </p>
                </section>
                ...
                <section style={{ marginBottom: '2.5rem' }}>
                    ...
                    <p style={{ lineHeight: '1.7', marginBottom: '1rem' }}>
                        Permission is granted to temporarily download one copy of the materials (information or software) on ResolveIt's website for personal, non-commercial transitory viewing only. This is the grant of a license, not a transfer of title, and under this license you may not:
                    </p>
                    <ul style={{ lineHeight: '1.7', paddingLeft: '1.5rem', marginTop: '0.5rem' }}>
                        ...
                        <li style={{ marginBottom: '0.5rem' }}>attempt to decompile or reverse engineer any software contained on ResolveIt's website;</li>
                ...
                <section style={{ marginBottom: '2.5rem' }}>
                    ...
                    <p style={{ lineHeight: '1.7', marginBottom: '1rem' }}>
                        The materials on ResolveIt's website are provided on an 'as is' basis. ResolveIt makes no warranties, expressed or implied, and hereby disclaims and negates all other warranties including, without limitation, implied warranties or conditions of merchantability, fitness for a particular purpose, or non-infringement of intellectual property or other violation of rights.
                    </p>
                </section>
                ...
                <section style={{ marginBottom: '2.5rem' }}>
                    ...
                    <p style={{ lineHeight: '1.7', marginBottom: '1rem' }}>
                        In no event shall ResolveIt or its suppliers be liable for any damages (including, without limitation, damages for loss of data or profit, or due to business interruption) arising out of the use or inability to use the materials on ResolveIt's website, even if ResolveIt or a ResolveIt authorized representative has been notified orally or in writing of the possibility of such damage.
                    </p>
                </section>

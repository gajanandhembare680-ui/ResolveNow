...
const StudentDashboard = () => {
    ...
    return (
        <div style={{ display: 'flex', minHeight: '100vh', background: 'var(--bg-gradient)' }}>
            {/* Sidebar */}
            <aside className="glass-panel" style={{ width: '250px', margin: '1rem', padding: '1.5rem', display: 'flex', flexDirection: 'column', borderRadius: '1rem' }}>
                ...
                <nav style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', flex: 1 }}>
                    <a
                        href="#"
                        onClick={(e) => { e.preventDefault(); setActiveView('submit'); }}
                        className="link"
                        style={{
                    ...
                    <a
                        href="#"
                        onClick={(e) => { e.preventDefault(); setActiveView('recent'); }}
                        className="link"
                        style={{
                            padding: '0.75rem 1rem',
                            display: 'flex',
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
                            ...
                            <div id="recent" className="glass-panel" style={{ padding: '2rem', borderRadius: '1rem', display: 'flex', flexDirection: 'column', flex: 1 }}>
                                ...
                                {studentComplaints.length === 0 ? (
                                    ...
                                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(600px, 1fr))', gap: '1rem' }}>
                                        ...
                                        {[...studentComplaints].reverse().map(complaint => {
                                            ...
                                            return (
                                                <div key={complaint.id} style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', padding: '1.5rem', background: 'rgba(255,255,255,0.6)', borderRadius: '0.75rem', border: '1px solid rgba(255,255,255,0.8)', transition: 'transform 0.2s ease, box-shadow 0.2s ease' }}
